...
public class SudentEx {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Student student = new Student(); 
		
		//student의 변수에 접근하여, name, age, stuNo, major 값을 지정하시오.
		student.name = "김조은";
		student.age = 20;
		...
		System.out.println("학생1 - 최종점수 점수 : " +student.getAverage(scores));
